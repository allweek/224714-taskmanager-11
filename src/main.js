...
const insertComponentToDOM = (position, template, placeElem) => {
...
insertComponentToDOM(`beforeend`, createBoard(), mainBlock);
...
for (let i = 0; i < TASK_COUNT; i++) {
  insertComponentToDOM(`beforeend`, createBoardTask(), boardTasks);
}

insertComponentToDOM(`beforeend`, createBtnLoadMore(), board);
